...
// --- FIX #1: Fetch from the correct 'profile_pic' column ---
...
if (!$user) { /* ... user not found logic ... */ }

// --- RESTORED: Fetch user's ratings and reviews ---
...
// --- RESTORED: Fetch the user's exchange history ---
...
<main class="page-main-content">
    <div class="container">
        <div class="profile-grid">
            <aside class="profile-card">
                <div class="profile-avatar">
                    <?php
                        ...
                        // --- FIX #2: Check the correct 'profile_pic' variable ---
            ...
            <!-- RESTORED: The entire right-hand column with all its content -->
